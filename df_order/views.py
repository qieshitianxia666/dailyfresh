...
def order_handle(request):
    ...
    try:
        ...
        count_cart = CartInfo.objects.filter(user_id=uid).count()
        print '############################'
        print type(count_cart), type(del_num)
        request.session['count'] = count_cart - int(del_num)
